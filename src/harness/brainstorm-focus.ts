import { BrainstormFocus, BrainstormOption, BrainstormQuestion } from '@/harness/brainstorm-types'
...
export const FOCUS_PLAYBOOKS: FocusPlaybook[] = [
  {
    ...
    label_ko: '기획',
    detect:
      /기획|요구사항|requirement|prd|mvp|scope|페르소나|persona|user story|유저스토리|로드맵|roadmap|kpi|지표|우선순위|priorit/i,
    questions: [
      {
        id: 'plan_goal',
        focus: 'planning',
  ...
  },
  {
    ...
    label_ko: 'UX·인터랙션',
    detect:
      /ux|ui\b|화면|플로우|flow|wireframe|와이어|프로토타입|prototype|사용성|usability|접근성|a11y|accessibility|journey|여정/i,
    questions: [
      {
        id: 'ux_primary_flow',
        focus: 'ux',
  ...
  },
  {
    ...
    label_ko: '비주얼·디자인',
    detect:
      /디자인|design system|디자인시스템|컴포넌트|figma|브랜드|brand|타이포|색상|color|토큰|token|shadcn|mui|tailwind/i,
    questions: [
      {
        id: 'visual_system',
        focus: 'visual_design',
  ...
  },
  {
    ...
    label_ko: 'DevOps·배포',
    detect:
      /devops|ci|cd|배포|deploy|docker|k8s|kubernetes|파이프라인|pipeline|github actions|환경|staging/i,
    questions: [
      {
        id: 'devops_env',
        focus: 'devops',
  ...
  },
  {
    ...
    label_ko: '관측',
    detect:
      /로그|log|metric|메트릭|trace|트레이스|monitor|모니터|알람|alert|sentry|datadog|observability/i,
    questions: [
      {
        id: 'obs_alert',
        focus: 'observability',
...
export function detectFocusFromTopic(
  topic: string,
  explicit?: BrainstormFocus[]
): BrainstormFocus[] {
