...
export const TOOL_KEYWORDS: ToolKeywordDef[] = [
  ...
  },
  {
    ...
    patterns: [/wiki.*(batch|일괄|여러)/i, /개념.*(batch|여러|일괄)/i],
    minScore: 4,
    textParam: 'title',
  ...
  },
  {
    ...
    patterns: [/ingest\s*pipeline/i, /(raw|원본).*(wiki|위키).*(lint|ingest)/i],
    minScore: 4,
    weight: 3,
    textParam: 'title',
  ...
  },
  {
    ...
    patterns: [/wiki\s*(mr|proposal|제안)/i],
    minScore: 4,
    textParam: 'title',
  ...
  },
  {
    ...
    category: 'wiki',
    keywords: ['wiki proposals', 'list_wiki_proposals', '제안 목록', 'pending wiki'],
    minScore: 4,
  ...
  },
  {
    ...
    category: 'wiki',
    keywords: ['apply wiki', 'apply_wiki_proposal', 'wiki merge', '제안 적용', 'wiki 승인'],
    minScore: 5,
  ...
  },
  {
    ...
    category: 'wiki',
    keywords: ['reject wiki', 'reject_wiki_proposal', '제안 거부'],
    minScore: 5,
  ...
  },
  {
    id: 'wiki_diff',
    category: 'wiki',
    keywords: ['wiki diff', 'wiki_diff', '위키 diff', '변경 미리보기'],
    minScore: 4,
    textParam: 'title',
  ...
  },
  {
    ...
    patterns: [/raw\s*inbox/i, /inbox\s*ingest/i],
    minScore: 4,
  ...
  },
  {
    id: 'list_vaults',
    category: 'wiki',
    keywords: ['list vaults', 'list_vaults', 'vault 목록', 'multi vault', '멀티 vault'],
    minScore: 4,
  ...
  },
  {
    id: 'register_vault',
    category: 'wiki',
    keywords: ['register vault', 'register_vault', 'vault 등록', 'vault 추가'],
    minScore: 5,
  ...
  },
  {
    ...
    category: 'ops',
    keywords: ['dashboard', 'get_dashboard_stats', '대시보드', 'wiki coverage', 'wiki 통계'],
    patterns: [/dashboard\s*stats/i],
    minScore: 4,
