...
export function resolveSessionSpawn(
  ...
  const def = DEFAULTS[runtime as Exclude<SessionRuntime, "custom">] || DEFAULTS.opencode;
...
export function listSessionRuntimes(): Array<{ id: SessionRuntime; command: string; args: string[] }> {
