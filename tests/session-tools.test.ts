...
import { spawnSession, waitForSession, closeSession, registerSessionTools, ChildSession } from "../src/mcp/tools/session-tools";
...
function emptySession(partial: Partial<ChildSession> & Pick<ChildSession, "id" | "status">): ChildSession {
  return {
    task: "",
    createdAt: 0,
    stdout: "",
